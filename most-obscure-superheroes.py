...
names = spark.read.schema(schema).option("sep", " ").csv("/home/vivek-s/projects/SparkCourse/Marvel+Names")

lines = spark.read.text("/home/vivek-s/projects/SparkCourse/Marvel+Graph")
